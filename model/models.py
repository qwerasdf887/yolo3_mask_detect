...
def Darknet_body(input_size, num_anchors, num_classes):
    ...
    y1 = tf.keras.layers.Reshape((input_size[0]//32, input_size[1]//32, num_anchors,num_classes+5), name='shape//32', dtype='float32')(y1)
    ...
    y2 = tf.keras.layers.Reshape((input_size[0]//16, input_size[1]//16, num_anchors,num_classes+5), name='shape//16', dtype='float32')(y2)
    ...
    y3 = tf.keras.layers.Reshape((input_size[0]//8, input_size[1]//8, num_anchors,num_classes+5), name='shape//8', dtype='float32')(y3)
